...
public class GDBaseControl: UIView {
    ...
    var originalContentInset = UIEdgeInsets.zero//if changing scroll view 's contentInset ia not first time  , you should set scrollView's contentInset to this property 
