...
public extension UIScrollView{
    ...
    @IBInspectable var gdRefreshControl: GDRefreshControl? {
        ...
        set(newValue) {
            ...
            if let instence = newValue {
                self.addSubview(instence)
                objc_setAssociatedObject(self, &UIScrollView.gdRefreshControl, instence, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
            }
        }
    }
