...
class DDNewFeature: DDNormalVC {
    ...
    let images  = ["feature1" , "feature2" ,"feature3","feature4"]
    var done  : (() -> ())?
    ...
    override func viewDidLoad() {
        ...
        if isNewVersion {
            ...
            jumpButton.frame = CGRect(x: self.view.bounds.width - buttonWH - 20, y: DDStatusBarHeight + buttonWH, width: buttonWH, height: buttonWH)
