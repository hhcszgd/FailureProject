...
//        pageControl.setValue(UIImage(named:"selectthecarousel"), forKeyPath: "_currentPageImage")
//        pageControl.setValue(UIImage(named:"carouselisnotselected"), forKeyPath: "_pageImage")
        pageControl.selectedImage = UIImage(named:"selectthecarousel")
        pageControl.normalImage = UIImage(named:"carouselisnotselected")
